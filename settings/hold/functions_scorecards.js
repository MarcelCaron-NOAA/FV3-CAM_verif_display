...
function getURL(baseline,fv3cam,domain,verif){
...
//	for(i=0; i<verifs.length; i++){
		...
		var urls = getURL(obj.baseline,obj.fv3cam,obj.domain,obj.verif);
...
//		verifs[idx_var].images[i].onerror = function(){remove_loading(this.varid,this.id);};
                verifs[idx_var].images[i].onerror = function(){remove_loading(this.varid,this.id); this.src='../../../../verification/style/images/noimage.png';};
