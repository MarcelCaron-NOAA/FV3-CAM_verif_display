...
function getURL(level,variable,cycle,stat,domain,fhr,time_period){
...
//	document.getElementById("baseline").selectedIndex = searchByName(imageObj.baseline,baselines);
	...
	if (imageObj.indep == "series_validhour_sfc" || imageObj.indep == "series_validhour_radar" || imageObj.indep == "series_validhour_vis" || imageObj.indep == "series_validhour_ceiling"){
...
//	for(i=0; i<levels.length; i++){
		...
		var urls = getURL(obj.level,obj.variable,obj.cycle,obj.stat,obj.domain,obj.fhr,obj.time_period);
...
function pressDown(){
	if (imageObj.indep == "series_validhour_sfc"){
