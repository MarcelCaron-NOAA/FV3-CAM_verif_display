...
function getURL(variable,level,cycle,domain,fhr,time_period){
...
//	for(i=0; i<levels.length; i++){
		...
		var urls = getURL(obj.variable,obj.level,obj.cycle,obj.domain,obj.fhr,obj.time_period);
