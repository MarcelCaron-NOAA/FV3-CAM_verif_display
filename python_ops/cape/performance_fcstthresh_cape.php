...
<div id="myModal" class="modal">
  <div class="modal-content" style="font-size:130%;">
    ...
    CAPE Performance Diagram Information
...
<!-- Image -->
<div id="page-map" style="text-align:left">
	<image name="map" style="width:180%">
</div>
...
levels.push({
        displayName: ">500 to >3000 J/kg",
        name: "gt500gt1000gt2000gt3000",
});
...
function initialize(){
	...
	imageObj = {
		indep: "performance_fcstthresh_cape",
		variable: "cape",
		level: "gt500gt1000gt2000gt3000",
		cycle: "00z",
                fhr: "f12",
		domain: "conus",
