...
<div id="myModal" class="modal">
  <div class="modal-content" style="font-size:130%;">
    ...
    Reflectivity and Echo Top Performance Diagram Information
...
*/
levels.push({
        displayName: ">= 20, 30, 40, 50",
        name: "ge20ge30ge40ge50",
});
...
function initialize(){
	...
	imageObj = {
		indep: "performance_fcstthresh_radar",
		variable: "refc",
		level: "ge20ge30ge40ge50",
		cycle: "00z",
                fhr: "f12",
		domain: "conus",
