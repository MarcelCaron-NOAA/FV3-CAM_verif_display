...
Up/Down arrow keys = Change Cycle | Left/Right arrow keys = Change Variable
...
<div id="myModal" class="modal">
  <div class="modal-content" style="font-size:130%;">
    ...
    Surface Variable Series by Forecast Lead Information
    <embed width=100% height=95% src="../info_series_fcstlead.php">
  </div>
</div>
<br>
<br>
...
*/
   ...
   var url = "PERIOD/<?php echo $url_head; ?>_lead_average_regional_DDD_init_CCC_VVV_SSS.png";
...
variables.push({
        displayName: "10-m Vector Wind",
        name: "10m_ugrd_vgrd",
});

variables.push({
        displayName: "Total Cloud Fraction",
        name: "tcdc",
});
