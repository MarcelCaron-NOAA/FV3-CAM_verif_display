...
<script type="text/javascript" src="../../settings/functions_series_fcstlead_python.js"></script>
...
<div class="table">
   <div class="element">
      ...
      <select id="stat" onchange="changeCycle(this.value)"></select>
   </div>
	<div class="element">
...
Up/Down arrow keys = Change Statistic | Left/Right arrow keys = Change Forecast Hour
...
<div id="myModal" class="modal">
  <div class="modal-content" style="font-size:130%;">
    ...
    Upper Level Variable Series by Level Information
    <embed width=100% height=95% src="../info_series_level.php">
  </div>
</div>
<br>
<br>
...
*/
   ...
   var url = "PERIOD/<?php echo $url_head; ?>_stat_by_level_regional_DDD_valid_CCC_VVV_SSS_FFF.png";
