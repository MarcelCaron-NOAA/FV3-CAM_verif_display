...
<script type="text/javascript" src="../../settings/functions_series_initdate_python.js"></script>
...
Up/Down arrow keys = Change Variable | Left/Right arrow keys = Change Forecast Hour
...
<div id="myModal" class="modal">
  <div class="modal-content" style="font-size:130%;">
    ...
    Surface Variable Series by Initialization Date Information
...
*/
   ...
   var url = "PERIOD/<?php echo $url_head; ?>_time_series_regional_DDD_init_CCC_VVV_SSS_FFF.png";
...
for(i=0;i<=10;i=i+1){
	fhrs.push({
        	displayName: "F"+formatString(i*6,2),
        	name: "f"+(i*6),
	});
}
