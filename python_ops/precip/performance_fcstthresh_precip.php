...
<div id="myModal" class="modal">
  <div class="modal-content" style="font-size:130%;">
    ...
    Precipitation Performance Diagram Information
...
levels.push({
        displayName: "1-h Thresholds",
        name: "ge0.254ge1.27ge2.54ge6.35ge12.7ge19.05ge25.4",
});
levels.push({
        displayName: "3-h Thresholds",
        name: "ge0.254ge1.27ge2.54ge6.35ge12.7ge19.05ge25.4ge50.8",
});
levels.push({
        displayName: "24-h Thresholds",
        name: "ge0.254ge2.54ge6.35ge12.7ge25.4ge38.1ge50.8ge76.2ge101.6ge152.4",
});
...
for(i=0;i<=5;i=i+1){
        fhrs.push({
                displayName: "F"+formatString(i*12,1),
                name: "f"+formatString(i*12,1),
        });
}
*/
...
function initialize(){
	...
	imageObj = {
		indep: "performance_fcstthresh_precip",
		variable: "3h_apcp",
		level: "ge0.254ge1.27ge2.54ge6.35ge12.7ge19.05ge25.4ge50.8",
		cycle: "00z",
                fhr: "f12",
		domain: "conus",
